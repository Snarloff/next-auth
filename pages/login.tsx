          ...
          <div className="bg-white shadow w-full rounded-lg divide-y divide-gray-200">
            ...
            <div className="p-5">
              <div className="grid grid-cols-3 gap-1">
                <button type="button"
                  className="transition duration-200 border border-gray-200 text-gray-500 w-full py-2.5 rounded-lg text-sm shadow-sm hover:shadow-md font-normal text-center inline-block">MailUp</button>
                <button type="button"
                ...
                <button type="button"
                  className="transition duration-200 border border-gray-200 text-gray-500 w-full py-2.5 rounded-lg text-sm shadow-sm hover:shadow-md font-normal text-center inline-block" onClick={() => signIn('github')}>Github</button>
              </div>
            </div>
            <div className="py-5">
            ...
            <div className="grid grid-cols-2 gap-1">
              <div className="text-center sm:text-left whitespace-nowrap">
                <button
                  ...
                  <span className="inline-block ml-1"><Link href="/">Back to your-app.com</Link></span>
                </button>
              </div>
            </div>
          </div>
